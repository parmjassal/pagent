...
class TODOTool:
    ...
    def add_task(self, title: str, description: str, assigned_to: Optional[str] = None, state: Optional[AgentState] = None) -> str:
    ...
    def update_task_status(self, task_id: str, status: str, state: Optional[AgentState] = None):
